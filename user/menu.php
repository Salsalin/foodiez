        ...
        <div class="row">
            ...
            <div class="col-md-8 menu-item">
                <div>
                    ...
                    <li><a href='order.php?item_id=$item_id' class='btn btn-default btn-sm pull-left'>Order Now</a></li>
                    <li><a href='users_review.php?item_id=$item_id' class='btn btn-default btn-sm pull-right'>Post Your Review</a></li>
